...
define Package/inode-client-auth
	SECTION:=net
	CATEGORY:=Network
...
define Package/inode-client-auth/Default/description
...
define Build/Compile  
	...
	$(CP) $(PKG_BUILD_DIR)/src/client $(PKG_BUILD_DIR)/src/njit-client
endef
...
# build a package.
$(eval $(call BuildPackage,inode-client-auth))
